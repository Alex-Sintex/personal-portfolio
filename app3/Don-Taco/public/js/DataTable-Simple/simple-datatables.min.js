                        ...
                        (function () {
                                        ...
                                        t.replace(O, function (r, l) {
                                            ...
                                            if (d) {
                                                (s = S(r)),
                                                    ...
                                                    s.voidElement || o || !u || "<" === u || (s.node.childNodes || (s.node.childNodes = []), s.node.childNodes.push({ nodeName: "#text", data: C(t.slice(h, t.indexOf("<", h))) })),
                                ...
                                T = (function () {
                                    function t(t, e, s) {
                                        (this.options = s),
                                            ...
                                            (this.foundAll = !1),
                                            this.debug &&
                                            ((this.t1Orig = "undefined" != typeof Element && t instanceof Element ? E(t, this.options) : "string" == typeof t ? k(t, this.options) : JSON.parse(JSON.stringify(t))),
                                        ...
                                        (t.prototype.findDiffs = function (t, e) {
                                            ...
                                            do {
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    (v(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : ((this.foundAll = !0), g(t), (s = this.findNextDiff(t, e, []))))),
                                                ...
                                                if (
                                                    ...
                                                    if (!this.options.maxChildCount || a < this.options.maxChildCount) r = r.concat(this.findNextDiff(u, p, s.concat(l)));
                                                        ...
                                                        if (i.length > n.length)
                                                            ...
                                                            var f = b(p);
                                                            (r = r.concat([
                                                                new N().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, f).setValue(this.options._const.route, s.concat(l)),
                                                            ])),
                                                                i.splice(h, 0, f),
                                                                (o -= 1);
                                                        } else
                                                ...
                                                if (!n || (!0 !== u[g] && !0 !== p[g]))
                                                    if (!0 === u[g])
                                                        if ("#text" === (l = t.childNodes[v]).nodeName)
                                                            ...
                                                            m.push(
                                                                new N().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))
                                                            ),
                                                                u.splice(g, 1),
                                                                (f = Math.min(u.length, p.length)),
                                                                (g -= 1);
                                                        ...
                                                        "#text" === (l = e.childNodes[g]).nodeName
                                                            ? (m.push(
                                                                new N().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.value, l.data)
                                                            ),
                                                                u.splice(g, 0, !0),
                                                                (f = Math.min(u.length, p.length)),
                                                                (v -= 1))
                                                            : (m.push(
                                                                new N().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))
                                                            ),
                                                                u.splice(g, 0, !0),
                                                                (f = Math.min(u.length, p.length)),
                                                                (v -= 1));
                            ...
                            const H = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: c }) => ({
                                ...
                                childNodes: t
                                    .map((t, h) => {
                                        ...
                                        const p = {};
                                        if (
                                            (u.sortable && o && (!r.length || c) && (u.filter ? (p["data-filterable"] = "true") : (p["data-sortable"] = "true")), u.headerClass && (p.class = u.headerClass), s.sort && s.sort.column === h)
                                        ) {
                                        ...
                                        return {
                                            ...
                                            attributes: p,
                                            childNodes:
                                                (!a && !r.length) || c ? (u.sortable && o ? [{ nodeName: "a", attributes: { href: "#", class: u.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: "#text", data: "" }],
                                        };
                                    })
                                    .filter((t) => t),
                            }),
                                R = (
                                    ...
                                    n,
                                    a,
                                    { classes: o, hiddenHeader: r, header: l, footer: d, format: c, sortable: h, scrollY: u, type: p, rowRender: f, tabIndex: m },
                                    ...
                                    if (((w.attributes.class = w.attributes.class ? `${w.attributes.class} ${o.table}` : o.table), l || d || v)) {
                                        const t = H(e, i, n, { classes: o, hiddenHeader: r, sortable: h, scrollY: u }, { noColumnWidths: g, unhideHeader: b });
                                        if (l || v) {
                                    ...
                                    return (
                                        ...
                                        (g.diff = function (s, h, u) {
                                            var p,
                                                ...
                                                v = N.m(this, m);
                                            return (
                                                (v = ((p = {}), (p[c] = v / 12), (p[l] = v), (p[d] = v / 3), (p[r] = (b - g) / 6048e5), (p[o] = (b - g) / 864e5), (p[a] = b / e), (p[n] = b / t), (p[i] = b / 1e3), p)[f] || b),
                                                u ? v : N.a(v)
                                            );
                                        }),
                                ...
                                z = (t, e) => {
                                    ...
                                    switch (e.type) {
                                        ...
                                        case "number":
                                            ...
                                            break;
                                        case "html": {
                                            const t = Array.isArray(s.data) ? { nodeName: "TD", childNodes: s.data } : k(`<td>${String(s.data)}</td>`);
                                            s.data = t.childNodes || [];
                                            const e = a(t);
                                            (s.text = e), (s.order = e);
                                            break;
                                        ...
                                        : e?.tHead
                                            ? (o.headings = Array.from(e.tHead.querySelectorAll("th")).map((t, e) => {
                                                const o = ((t) => {
                                                    ...
                                                    let s;
                                                    return (
                                                        (s = !e.childNodes || (1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName) ? { data: t.innerText, type: "string" } : { data: e.childNodes, type: "html", text: a(e) }), s
                                                    );
                                                })(t);
                                            ...
                                            : t.data?.length
                                                ...
                                                : e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t) => J("")));
                                                    ...
                                                    const i = t.dataset.content
                                                        ...
                                                        : ((t, e) => {
                                                            ...
                                                            switch (e.type) {
                                                                ...
                                                                default:
                                                                    s = { data: E(t, { valueDiffing: !1 }).childNodes || [], text: t.innerText, order: t.innerText };
                                                            }
                                                            return s;
                                                        })(t, s[e]);
                            ...
                            const X = {
                                ...
                                classes: {
                                    ...
                                    table: "content-table datatable-table",
                                    top: "datatable-top",
                            ...
                            class tt {
                                ...
                                saveRow(t, e) {
                                    ...
                                    (this.dt.data.data[this.data.rowIndex] = this.dt.data.data[this.data.rowIndex].map((e, s) => {
                                        ...
                                        else if ("boolean" === i) o = ["", "false", "0"].includes(a) ? { data: !1, text: "false", order: 0 } : { data: !0, text: "true", order: 1 };
                                        else if ("html" === i) o = { data: [{ nodeName: "#text", data: n }], text: n, order: n };
                                ...
                                dismiss(t) {
                                    ...
                                    if (!(e instanceof Element)) return;
                                    let s = !0;
                                    this.options.contextMenu && ((s = !this.wrapperDOM.contains(e)), this.editing && (s = !this.wrapperDOM.contains(e) && !e.matches(`input.${this.options.classes.input}[type=text]`))),
                                    ...
                                    return this.data && this.data.rowIndex === s
                                        ? (this.editingCell
                                            ? (e.childNodes[l(this.data.columnIndex, this.dt.columns.settings)].childNodes = [
                                                { nodeName: "INPUT", attributes: { type: "text", value: this.data.content, class: this.options.classes.input } },
                                            ])
                                            : e.childNodes.forEach((s, i) => {
                                                const n = r(i, this.dt.columns.settings),
                                                    a = t[n];
                                                this.options.excludeColumns.includes(n) ||
                                                    (e.childNodes[i].childNodes = [{ nodeName: "INPUT", attributes: { type: "text", value: o(a.text || String(a.data) || ""), class: this.options.classes.input } }]);
                                            }),
                                            e)
                                        : e;
                                }
                            ...
                            (s.DataTable = class {
                                ...
                                _renderPagers() {
                                    ...
                                    let t = ((t, e, s, i, n) => {
                                                            ...
                                                            if (h) {
                                                                ...
                                                                if (s - e == 2) u.push(t[e]);
                                                                    ...
                                                                    const t = {
                                                                        ...
                                                                        childNodes: [{ nodeName: "A", attributes: { class: a.paginationListItemLink }, childNodes: [{ nodeName: "#text", data: o }] }],
                                                                    };
                                                                    u.push(t);
                                                                }
                                                            }
                                        ...
                                        return n.firstLast && a.push(G(i, n.lastText, n)), { nodeName: "UL", attributes: { class: n.classes.paginationList }, childNodes: o.length > 1 ? a : [] };
                                ...
                                _renderSeparateHeader() {
                                    ...
                                    let e = {
                                        ...
                                        childNodes: [{ nodeName: "THEAD", childNodes: [H(this.data.headings, this.columns.settings, this.columns._state, this.options, { unhideHeader: !0 })] }],
                                    };
                                    if (this.options.tableRender) {
                                ...
                                multiSearch(t) {
                                    ...
                                    if (((this._currentPage = 1), (this._searchQueries = t), (this._searchData = []), !(t = t.filter((t) => t.term.length)).length))
                                        return this.update(), this.emit("datatable.multisearch", t, this._searchData), this.wrapperDOM.classList.remove("search-results"), !1;
                                    const e = t.map((t) =>
                                    ...
                                    if (Array.isArray(t)) {
                                        ...
                                        t.forEach((t, i) => {
                                            ...
                                            Object.entries(t).forEach(([t, s]) => {
                                                ...
                                                a > -1
                                                    ...
                                                    : this.hasHeadings || this.hasRows || 0 !== i || ((n[e.length] = z(s, this.columns.settings[e.length])), e.push(t), this.data.headings.push(J(t)));
                                            }),
                                                s.push(n);
                                        });
                                    } else
                                        e(t) &&
                                            (!t.headings || this.hasHeadings || this.hasRows
                                                ? t.data && Array.isArray(t.data) && (s = t.data.map((t) => t.map((t, e) => z(t, this.columns.settings[e]))))
                                                : (this.data = W(t, void 0, this.columns.settings, this.options.type, this.options.format)));
                                ...
                                setMessage(t) {
                                    ...
                                    let s = {
                                        ...
                                        attributes: { class: this.options.classes.table },
                                        childNodes: [
                                            { nodeName: "THEAD", childNodes: [H(this.data.headings, this.columns.settings, this.columns._state, this.options, {})] },
                                            {
                                                nodeName: "TBODY",
                                ...
                                (s.exportCSV = function (t, s = {}) {
                                    ...
                                    if (((a[0] = o), i.selection))
                                        if (Array.isArray(i.selection)) for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t) => t.row.filter((t, e) => n(e)).map((t) => t.text ?? t.data)));
                                ...
                                (s.exportJSON = function (t, s = {}) {
                                    ...
                                    let a = [];
                                    if (i.selection)
                                        if (Array.isArray(i.selection)) for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t) => t.row.filter((t, e) => n(e)).map((t) => t.data)));
