...
$(document).ready(function () {
    ...
    fetch('balance/check_email_verification')
        .then(res => res.json())
        .then(data => {
            isUserEmailVerified = data.verified;
        })
        .catch(err => {
        ...
        .finally(() => {
            ...
            let columCalDefs = [
                ...
                { data: 'total', title: 'TOTAL PLATAFORMA', render: currencyRender },
                ...
                buttons: (function () {
                    ...
                    if (isUserEmailVerified) {
                        buttons.push({
                            ...
                            action: function () {
                                if (confirm("¿Deseas enviar el reporte PDF a tu correo?")) {
                                    fetch('balance/email_pdf', {
                                        method: 'POST',
                                        headers: {
