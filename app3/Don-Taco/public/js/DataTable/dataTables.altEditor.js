            ...
            altEditor.prototype,
            {
                ...
                _setup: function () {
                    ...
                    var modal = '<div class="modal fade altEditor-modal reveal" id="' + modal_id + '" tabindex="-1" role="dialog" data-reveal>' +
                        ...
                        '<button style="margin: initial;" type="button" class="close" data-bs-dismiss="modal" aria-label="' + this.language.modalClose + '">' +
                ...
                _initLanguage: function () {
                    ...
                    this.language.delete = {
                        ...
                        button: this.language.delete.button || 'Borrar'
                    };
                ...
                */
                createDialog: function (columnDefs, modalTitle, buttonCaption, closeCaption, buttonClass, formName) {
                    ...
                    var fill = function () {
                        var btns =
                            '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">' + closeCaption + '</button>' +
