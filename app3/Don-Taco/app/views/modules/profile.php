                            ...
                            <div class="py-2">
                                ...
                                <div class="row py-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div id="verify-alert" class="alert alert-warning mt-3" style="display:none;">
                                            <span id="verify-message"></span>
                                            <span id="verify-icon" style="margin-left: 10px;"></span>
                                        </div>

                                        <?php if ($isVerified): ?>
                                            <div class="alert alert-success mt-3" id="email-verified">
                                                <i class="fa fa-check-circle text-success"></i>
                                                <span>Correo verificado</span>
                                            </div>
                                        <?php else: ?>
                                            <div class="alert alert-warning d-flex align-items-center gap-2 mt-3" id="email-not-verified" role="alert">
                                                <i class="fa fa-exclamation-triangle text-warning"></i>
                                                <div>
                                                    <strong>Tu correo no está verificado.</strong><br>
                                                    Por favor revisa tu bandeja de entrada o
                                                    <a id="resend-verification" href="javascript:void(0)" class="alert-link">reenviar confirmación</a>.
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
