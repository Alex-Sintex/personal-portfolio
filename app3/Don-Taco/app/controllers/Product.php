    ...
    public function insert()
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'message' => 'Se ha agregado un nuevo producto para la fecha: ' . $cleanData['date'],
                'link'    => '/product'
            ]);
        }
    ...
    public function update($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'message' => 'Se ha actualizado un nuevo producto',
                'link'    => '/product'
            ]);
        }
    ...
    public function delete($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'message' => 'Se eliminó un producto con ID: ' . $id,
                'link'    => '/product'
            ]);
        }
