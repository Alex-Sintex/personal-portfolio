    ...
    public function insert()
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'type'    => 'Gastos fijos diarios',
                'title'   => 'Nuevo gasto fijo diario agregado',
                'message' => 'Se ha agregado un nuevo gasto fijo diairo para la fecha: ' . $cleanData['date'],
                'link'    => '/gastosfd'
            ]);
        }
    ...
    public function update($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                'user_id' => $_SESSION['user_id'],
                'type'    => 'Gastos fijos diarios',
                'title'   => 'Gasto fijo diario actualizado',
                'message' => 'Se ha actualizado un nuevo gasto fijo diario para la fecha: ' . $cleanData['date'],
                'link'    => '/gastosfd'
            ]);
        }
    ...
    public function delete($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'type'    => 'Gastos fijos diarios',
                'title'   => 'Gasto fijo diario actualizado',
                'message' => 'Se eliminó un gasto fijo diario con ID: ' . $id,
                'link'    => '/gastosfd'
            ]);
        }
