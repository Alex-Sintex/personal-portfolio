    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">GASTOS FIJOS DIARIOS</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        CONTROL DE GASTOS FIJOS DIARIOS
                    </div>
                </div>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        TABLA DE GASTOS FIJOS DIARIOS
                    </div>
                    <div class="card-body">
                        <table id="tableGFD" class="content-table" style="width:100%"></table>
                    </div>
                </div>
            </div>
        </main>
