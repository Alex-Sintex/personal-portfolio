...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo PATH_URL; ?>">
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseMod1" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="<?= PATH_URL; ?>balance/balance">Balance</a>
                                    </nav>
                                </div>
                                ...
                                <div class="collapse" id="pagesCollapseMod4" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="#">Gastos diarios</a>
                                    </nav>
                                </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            En este módulo se muestran únicamente todos los registros correspondientes al balance, aquí podra:
                            <a href="#">añadir, editar o eliminar cualquier dato de ser necesario</a>.
                        </div>
                    </div>
                    <div class="card mb-4">
    ...
    <script src="<?= PATH_URL ?>js/DataTable-Simple/datatables-simple-demo.js"></script>
</body>
