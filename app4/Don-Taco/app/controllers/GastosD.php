    ...
    public function insert()
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'type'    => 'Gastos diarios',
                'title'   => 'Nuevo gasto diario agregado',
                'message' => 'Se ha agregado un nuevo gasto diario para la fecha: ' . $cleanData['date'],
                'link'    => '/gastosd'
            ]);
        }
    ...
    public function update($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                'user_id' => $_SESSION['user_id'],
                'type'    => 'Gastos diarios',
                'title'   => 'Gasto diario actualizado',
                'message' => 'Se ha actualizado un gasto diario para la fecha: ' . $cleanData['date'],
                'link'    => '/gastosd'
            ]);
        }
    ...
    public function delete($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                'user_id' => $_SESSION['user_id'],
                'type'    => 'Gastos diarios',
                'title'   => 'Gasto diario eliminado',
                'message' => 'Se eliminó un gasto diario con ID: ' . $id,
                'link'    => '/gastosd'
            ]);
        }
