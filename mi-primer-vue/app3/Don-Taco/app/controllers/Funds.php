    ...
    public function insert()
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'type'    => 'Tarjeta KLAR',
                'title'   => 'Nuevo fondo agregado',
                'message' => 'Se ha agregado un nuevo fondo para la fecha: ' . $cleanData['date'],
                'link'    => '/funds'
            ]);
        }
    ...
    public function update($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'message' => 'Se ha actualizado un fondo para la fecha: ' . $cleanData['date'],
                'link'    => '/funds'
            ]);
        }
    ...
    public function delete($id)
    {
        ...
        if ($result) {
            $this->notifier->send([
                ...
                'message' => 'Se eliminó un fondo con ID: ' . $id,
                'link'    => '/funds'
            ]);
        }
